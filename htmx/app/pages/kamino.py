...
PAGE_CONFIG = PageConfig(
    ...
    widgets=[
        # Left col: a1–a10
        WidgetConfig("kpi-loan-value", "Loan Value Outstanding", "kpi", "panel panel-kpi kamino-slot-kpi-a1",
                     tooltip="The total value of debt outstanding across all obligations and all tokens, valued in market quote currency."),
        WidgetConfig("kpi-share-borrow-asset", "Share by Borrow Asset", "kpi", "panel panel-kpi kamino-slot-kpi-a2",
                     tooltip="Share of total outstanding debt represented by each borrow asset in this market."),
        WidgetConfig("kpi-utilization-by-reserve", "Utilization Factor by Reserve", "kpi", "panel panel-kpi kamino-slot-kpi-a3",
        ...
        WidgetConfig("kpi-borrow-apy", "Current Borrow APY by Asset", "kpi", "panel panel-kpi kamino-slot-kpi-a4",
                     tooltip="The core APY excluding any additional rewards or incentive programs."),
        WidgetConfig("kpi-supply-apy", "Current Supply APY by Asset", "kpi", "panel panel-kpi kamino-slot-kpi-a5",
                     tooltip="The core APY excluding any additional rewards or incentive programs."),
        WidgetConfig("kpi-borrow-vol-24h", "24h Borrow Volume by Asset", "kpi", "panel panel-kpi kamino-slot-kpi-a6"),
        WidgetConfig("kpi-repay-vol-24h", "24h Repay Volume by Asset", "kpi", "panel panel-kpi kamino-slot-kpi-a7"),
        WidgetConfig("kpi-deposit-vol-24h", "24hr Deposit Volume by Asset", "kpi", "panel panel-kpi kamino-slot-kpi-a8"),
        WidgetConfig("kpi-withdraw-vol-24h", "24hr Withdraw Volume by Asset", "kpi", "panel panel-kpi kamino-slot-kpi-a9"),
        WidgetConfig("kpi-days-no-liquidation", "Days without Liquidations", "kpi", "panel panel-kpi kamino-slot-kpi-a10"),
        # Right col: b1–b10
        WidgetConfig("kpi-collateral-value", "Collateral Deposited", "kpi", "panel panel-kpi kamino-slot-kpi-b1",
                     tooltip="The total value of collateral deposited across all obligations and all tokens, valued in market quote currency."),
        WidgetConfig("kpi-share-collateral-asset", "Share by Collateral Asset", "kpi", "panel panel-kpi kamino-slot-kpi-b2",
                     tooltip="Share of total collateral value represented by each collateral asset accepted in this market."),
        WidgetConfig("kpi-obligations-debt-size", "Number of Obligations with Debt and Avg.Size", "kpi", "panel panel-kpi kamino-slot-kpi-b3",
                     tooltip="Count of obligations with non-negligible debt and the average debt value held by them."),
        WidgetConfig("kpi-ltv-hf", "Avg. Current Loan LTV / HF", "kpi", "panel panel-kpi kamino-slot-kpi-b4",
        ...
        WidgetConfig("kpi-unhealthy-share", "Unhealthy Loans as Share of Total", "kpi", "panel panel-kpi kamino-slot-kpi-b5",
                     tooltip="Share of total outstanding debt value currently marked as unhealthy."),
        WidgetConfig("kpi-zero-use-count", "Zero-Use Accounts", "kpi", "panel panel-kpi kamino-slot-kpi-b6",
                     tooltip="The number of accounts with deposits only and no outstanding loans."),
        WidgetConfig("kpi-zero-use-capacity", "Zero-Use Capacity", "kpi", "panel panel-kpi kamino-slot-kpi-b7",
        ...
        WidgetConfig("kpi-liquidation-vol-30d", "30d Liquidation Volume", "kpi", "panel panel-kpi kamino-slot-kpi-b9"),
        WidgetConfig("kpi-liquidation-avg-size", "Average Liquidation Size", "kpi", "panel panel-kpi kamino-slot-kpi-b10"),
        # Charts (2-col layout)

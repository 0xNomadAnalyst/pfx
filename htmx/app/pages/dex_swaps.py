...
PAGE_CONFIG = PageConfig(
    ...
    widgets=[
        ...
        WidgetConfig("kpi-largest-usx-buy", "Largest USX Buy Trade & Est. Current Impact", "kpi", "panel panel-kpi swaps-slot-kpi-a4"),
        WidgetConfig("kpi-largest-usx-sell", "Largest USX Sell Trade & Est. Current Impact", "kpi", "panel panel-kpi swaps-slot-kpi-b4"),
        WidgetConfig("kpi-max-1h-buy-pressure", "Max. 1hr. USX Buy Pressure & Est. Current Impact", "kpi", "panel panel-kpi swaps-slot-kpi-a5"),
        WidgetConfig("kpi-max-1h-sell-pressure", "Max. 1hr. USX Sell Pressure & Est. Current Impact", "kpi", "panel panel-kpi swaps-slot-kpi-b5"),
        ...
        WidgetConfig("swaps-ohlcv", "Candlestick Chart", "chart", "panel panel-medium swaps-slot-mid-2"),
        WidgetConfig("swaps-distribution-toggle", "Downside Event Distribution", "chart", "panel panel-medium swaps-slot-mid-3",

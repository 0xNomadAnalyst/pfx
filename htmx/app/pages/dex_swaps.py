...
WIDGETS: list[WidgetConfig] = [
    ...
    WidgetConfig("swaps-flows-toggle", "Swap Flows", "chart", 60, "panel panel-medium swaps-slot-mid-1"),
    WidgetConfig("swaps-price-impacts", "Max. & Avg. Price Impacts", "chart", 60, "panel panel-medium swaps-slot-mid-2"),
    WidgetConfig("swaps-spread-volatility", "VWAP Spread & Volatility (Std. Dev.)", "chart", 60, "panel panel-medium swaps-slot-mid-3"),

...
PAGE_CONFIG = PageConfig(
    ...
    widgets=[
        ...
        WidgetConfig("kpi-price-min-max", "Price Min / Max", "kpi", "panel panel-kpi swaps-slot-kpi-a2"),
        ...
        WidgetConfig("kpi-vwap-spread", "VWAP Spread", "kpi", "panel panel-kpi swaps-slot-kpi-b3"),
        WidgetConfig("kpi-largest-usx-sell", "Largest USX Sell", "kpi", "panel panel-kpi swaps-slot-kpi-a4"),
        WidgetConfig("kpi-largest-usx-buy", "Largest USX Buy", "kpi", "panel panel-kpi swaps-slot-kpi-b4"),
        WidgetConfig("kpi-max-1h-sell-pressure", "Max 1h Sell Pressure", "kpi", "panel panel-kpi swaps-slot-kpi-a5"),

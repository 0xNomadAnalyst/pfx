...
# Source page + source widget -> backend data family.
# Families are intentionally high-level and used only for sync-group testing.
DATA_FAMILY_HINTS: dict[tuple[str, str], str] = {
    # Dex liquidity
    ...
    ("playbook-liquidity", "trade-size-to-impact"): "dex_liquidity_timeseries",
